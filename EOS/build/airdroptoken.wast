(module
 ...
 (data (i32.const 448) "overflow detected\00")
 (data (i32.const 480) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 544) "you doesn\'t have account\00")
 (data (i32.const 576) "overdrawn balance\00")
