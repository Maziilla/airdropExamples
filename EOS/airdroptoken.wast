(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN7airdrop12airdroptoken6supplyEy $_ZN7airdrop12airdroptoken7moneyofEy)
 (memory $0 1)
 ...
 (data (i32.const 96) "Total supply: \00")
 (data (i32.const 112) "Money: \00")
 ...
 (export "_ZN7airdrop12airdroptoken6supplyEy" (func $_ZN7airdrop12airdroptoken6supplyEy))
 (export "_ZN7airdrop12airdroptoken7moneyofEy" (func $_ZN7airdrop12airdroptoken7moneyofEy))
 ...
 (func $_ZN7airdrop12airdroptoken6supplyEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN7airdrop12airdroptoken7moneyofEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (call $require_auth
   (get_local $1)
  )
  (set_local $0
   (call $_ZNK5eosio11multi_indexILy3607749779137757184EN7airdrop12airdroptoken7accountEJEE3getEy
    (i32.add
     (get_local $0)
     (i32.const 8)
    )
 ...
 (func $_ZNK5eosio11multi_indexILy3607749779137757184EN7airdrop12airdroptoken7accountEJEE3getEy (param $0 i32) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
    ...
    (block $label$2
     (block $label$3
      (br_if $label$3
       (i64.eq
        (get_local $2)
        (i64.const -7699273748905459712)
       )
      )
      (br_if $label$0
       (i64.ne
        (get_local $2)
        (i64.const -4131110411007164416)
       )
      )
      (i32.store offset=36
       (get_local $7)
