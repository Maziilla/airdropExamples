(module
 ...
 (table 4 4 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN7airdrop12airdroptoken11totalsupplyEy $_ZN7airdrop12airdroptoken9balanceofEy $_ZN7airdrop12airdroptoken8transferEyyy)
 (memory $0 1)
 ...
 (data (i32.const 96) "that user doesn\'t exist\00")
 (data (i32.const 128) "User \00")
 (data (i32.const 144) " have \00")
 (data (i32.const 160) "error reading iterator\00")
 (data (i32.const 192) "read\00")
 (data (i32.const 208) "you doesn\'t have account\00")
 (data (i32.const 240) "overdrawn balance\00")
 ...
 (data (i32.const 576) "overflow detected\00")
